...
/* NOT WORKING VER PORQUÊ!
-- ======================================================================================================
-- Author:					Sofia José
-- Create date:				07/07/2021
-- Stored Procedure Name:	replace_nulls_with_string
-- Description:				Replace null values with the string 'null'
--
-- Parameters:
--	@database - database where to do the replacement
--	@schema - schema where to do the replacement
--	@table - table where to do the replacement
--	@column - column where to do the replacement 
-- =======================================================================================================

CREATE or ALTER PROCEDURE replace_nulls_with_string
...
AS   
	...
	Set @path = @database+'.'+@schema+'.'+@table;
...
--exec replace_nulls_with_string 'bdks','solutions','extraRight','solution'

-- give user TeseASCJ the capacity to execute the above stored procedure
GRANT EXEC ON dbo.replace_nulls_with_string TO [TeseASCJ];
GO
